...
const MacOSDock: React.FC<MacOSDockProps> = ({
  ...
  const maxScaleInRow = Math.max(...currentScales);
...
const createBounceAnimation = (element: HTMLElement) => {
  ...
  element.style.transition = 'transform 0.02s ease-out';
...
const padding = Math.max(8, baseIconSize * 0.12);
const dynamicDockHeight = baseIconSize * maxScaleInRow + padding * 2;
...
return (
    ...
    >
      <div
        className="relative"
        style={{
          height: `${baseIconSize * maxScaleInRow}px`,
          width: '100%',
          ...
          return (
            ...
            >
              <img
                ...
                width={scaledSize}
                height={scaledSize}
                className="object-contain pointer-events-none" // ✅ FIX
                style={{
              ...
              {openApps.includes(app.id) && (
                <div
                  ...
                  style={{
                    ...
                    width: `${Math.max(5, baseIconSize * 0.08)}px`,
                    height: `${Math.max(5, baseIconSize * 0.08)}px`,
                    borderRadius: "50%",
                    backgroundColor: "rgba(0, 0, 0, 0.9)", // black dot
                    boxShadow: "0 0 6px rgba(0, 0, 0, 0.4)", // soft black glow
                    zIndex: 20,
                  }}
                />
              )}
