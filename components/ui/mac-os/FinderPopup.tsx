  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full bg-white flex overflow-hidden">
        {/* Sidebar */}
        {sidebarOpen && (
          <div className="w-64 bg-white border-r border-gray-300 p-4 flex flex-col overflow-y-auto">
            <div className="flex items-center gap-2 mb-4 text-gray-900 font-semibold text-lg">
              <Folder size={18} /> Favourites
            </div>
        ...
        <div className="flex-1 flex flex-col">
            ...
            <div className="flex items-center gap-3">
              ...
              <Grid
                ...
                className={`cursor-pointer transition ${
                  viewMode === 'grid' ? 'text-blue-600' : 'text-gray-700 hover:text-black'
                }`}
              />
              <LayoutGrid
                size={18}
                ...
                className={`cursor-pointer transition ${
                  viewMode === 'list' ? 'text-blue-600' : 'text-gray-700 hover:text-black'
                }`}
              />
              <Upload
                size={18}
          ...
          {/* Status Bar */}
          <div className="h-8 bg-white border-t border-gray-300 flex items-center justify-between px-4 text-xs text-gray-500">
