...
export function FeatureShowcase({
  ...
  return (
    <section className={cn("w-full bg-background text-foreground", className)}>
      <div className="container mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 py-12 md:grid-cols-12 md:py-15 lg:gap-14">
        {/* Left column */}
        <div className="md:col-span-6">

          <h2 className="text-4xl font-bold leading-[0.95] sm:text-5xl md:text-6xl">
            {title}
          </h2>
                ...
                {tabs.map((t, idx) => (
                  ...
                  >
                    <Image
                      ...
                      alt={t.alt ?? t.label}
                      fill
                      priority={idx === 0} // eager for first image
