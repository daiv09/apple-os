...
export default function Clients() {
  return (
    //   <main className="w-full min-h-screen flex flex-col justify-center items-center bg-light-200 px-4 py-6">
    <section className="max-w-4xl w-full flex flex-col items-center gap-6 -mt-10">
